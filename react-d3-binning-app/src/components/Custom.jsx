...
const Custom = ({data, bins, binSize, maxHeight = 300}) => {
  ...
  const columns = useMedia({
    ...
    values: [maxBinLength, maxBinLength, maxBinLength, 2],
    defaultValue: 2,
  });
  ...
  useEffect(() => {
    ...
    d3.select(xAxisDomRef.current)
      ...
      .duration(500)
      .call(
        d3.axisBottom(xScale).ticks(columns) // pc >>> maxBinLength sp >>> 2
      );
  ...
  }, [data, dimensions, bins, maxHeight, binSize]);
